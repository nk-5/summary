...
public class Rank: NSObject {
    ...
    init(id: String, users: [User?], admin: String, category: String, items: [Item], deadline: Timestamp, icon: Data?, permission: Int, minimumRequirement: Int, resultScope: Bool, scope: Bool, type: Int, comments: [String: String?]) {
        self.id = id
        self.users = users
        self.admin = admin
